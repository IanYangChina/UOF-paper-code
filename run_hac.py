...
if __name__ == '__main__':
    ...
    print("Task id %i, env name %s " % (args['task_id'], hac_env_ids[args['task_id']]))
    Params.ENV_ID = args['task_id']
    Params.ENV_NAME = hac_env_ids[args['task_id']]
    ...
    Params.PATH = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'result', 'hac_task_'+str(Params.ENV_ID))
